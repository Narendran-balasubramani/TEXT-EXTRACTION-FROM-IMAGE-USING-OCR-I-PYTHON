...
def imggen(path):
    ...
    resized = photo.resize((570, 480), Image.Resampling.LANCZOS)
    converted = ImageTk.PhotoImage(resized)

label = Tk.Label(root, image= converters, x=0,y=100,width=600,height=500)
label.pack()
...
img_lbl = Label(btn_frame , text="IMAGE FIELD" , font=("times new roan",15,"bold"), fg="white",bg="black")
